...
void KondoModel::set_operators(double J, double Bz, double Bx, double t, double tPrime, double U, size_t D)
{
	...
	if (Bx != 0.)
	{
		this->Olocal.push_back(std::make_tuple(-Bx, kroneckerProduct(SpinBase::Scomp(SX,D), Id4)));
	}
