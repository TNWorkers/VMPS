#ifndef FERMIONSITEU0xSU2_H_
#define FERMIONSITEU0xSU2_H_
...
template <>
class FermionSite<Sym::SU2<Sym::ChargeSU2> >
{
...
FermionSite(bool U_IS_INFINITE, bool UPH_IS_INFINITE)
{
	...
	cupA_1s_ = OperatorType({2},basis_1s_);
	cupB_1s_ = OperatorType({2},basis_1s_);
	cdnA_1s_ = OperatorType({2},basis_1s_);
	cdnB_1s_ = OperatorType({2},basis_1s_);
	nh_1s_ = OperatorType({1},basis_1s_);
	T_1s_ = OperatorType({3},basis_1s_);
