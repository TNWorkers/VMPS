...
$\left|\Psi_{out}\right> = \cdot H \left|\Psi_{in,1}\right> - B \left|\Psi_{in,2}\right>$
\pagebreak
...
\[ H = -t \sum_{<ij>} \left(c^\dagger_i c_j + h.c.\right) +\Delta \sum_{<ij>} \left(c^\dagger_i c_j + h.c.\right) -\mu \sum_i n_i \]
\pagebreak
...
\[ H = J_{xy} \sum_{<ij>} \left(S^x_iS^x_j+S^y_iS^y_j\right) + J_z \sum_{<ij>} S^z_iS^z_j +J'_{xy} \sum_{<<ij>>} \left(S^x_iS^x_j+S^y_iS^y_j\right) + J'_z \sum_{<<ij>>} S^z_iS^z_j -B_z \sum_i S^z_i +K_z \sum_i \left(S^z_i\right)^2 -D_y \sum_{<ij>} \left(\mathbf{S_i} \times \mathbf{S_j}\right)_y -D_y' \sum_{<<ij>>} \left(\mathbf{S_i} \times \mathbf{S_j}\right)_y \]
\pagebreak
