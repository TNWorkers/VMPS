 ...
 * - The calculation of the environment involves infinite contractions that are carried out by solving linear systems eq. 14 or eq. C25ab. This is handled in VumpsTransferMatrix.h\.
 ...
 * - It is possible to run the algorithm with a 2-site Hamiltonian (without an MPO), see algorithm 2. This involves the local updates eq. 11 and eq. 16 which are handled in VumpsPivotStuff.h\.
