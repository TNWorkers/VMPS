...
int main (int argc, char* argv[])
{
	...
	// g_SU2.state.applyGate(Swap,0,DMRG::DIRECTION::LEFT);
	// cout << g_SU2.state << endl;
	// cout << "Applied Swap Gate once:" << endl;
	// cout << "dot=" << g_SU2.state.dot(g_SU2.state) << endl;
	// // g_SU2.state.applyGate(Swap,0,DMRG::DIRECTION::RIGHT);
	// cout << g_SU2.state.info() << endl;
	// cout << "E=" << avg(g_SU2.state,H_SU2,g_SU2.state) << endl;
	...
	g_U1.state.applyGate(Swap,swapSite,DMRG::DIRECTION::RIGHT);
	// cout << g_U1.state << endl;
	// g_U1.state.applyGate(Swap,swapSite,DMRG::DIRECTION::RIGHT);
	cout << g_U1.state.info() << endl;
	cout << "Applied Swap Gate once:" << endl;
