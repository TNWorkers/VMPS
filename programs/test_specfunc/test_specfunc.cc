...
//	}
	...
	#pragma omp parallel sections
	{
		#pragma omp section
		{
			...
			DMRG->edgeState(H, *init, Qi, LANCZOS::EDGE::GROUND, LANCZOS::CONVTEST::SQ_TEST, 1e-7,1e-6, 4,500, 50,10);
		...
		#pragma omp section
		{
			...
			gDMRG->edgeState(H, *g, Qc, LANCZOS::EDGE::GROUND, LANCZOS::CONVTEST::SQ_TEST, 1e-8,1e-6, 8,500, 50,10);
...
//			lout << "thread(r): " << omp_get_thread_num() << endl;
			...
			rDMRG->edgeState(H, *r, Qc, LANCZOS::EDGE::ROOF, LANCZOS::CONVTEST::SQ_TEST, 1e-8,1e-6, 8,500, 50,10);
