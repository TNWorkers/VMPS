...
//	HubbardModel H_EDmm(Lx*Ly,Nup-1,Ndn-1,U,BondMatrix.sparseView(), BC_DANGLING);
	...
	DMRG_U0.edgeState(H_U0, g_U0, {}, LANCZOS::EDGE::GROUND, DMRG::CONVTEST::VAR_2SITE, 10.*tol_eigval,10.*tol_state, Dinit,3*Dlimit, Imax,Imin, 0.1);
...
//	double E_U0_compressor = g_U0.state.dot(Hxg_U0);
	...
	DMRG_U1.edgeState(H_U1, g_U1, {Nup,Ndn}, LANCZOS::EDGE::GROUND, DMRG::CONVTEST::VAR_2SITE, tol_eigval,tol_state, Dinit,Dlimit, Imax,Imin, alpha);
	
	t_U1 = Watch_U1.time();
	
	Eigenstate<VMPS::HubbardU1xU1::StateXd> g_U1m;
	DMRG_U1.set_verbosity(DMRG::VERBOSITY::SILENT);
	DMRG_U1.edgeState(H_U1, g_U1m, {Nup-1,Ndn}, LANCZOS::EDGE::GROUND, DMRG::CONVTEST::VAR_2SITE, tol_eigval,tol_state, Dinit,Dlimit, Imax,Imin, alpha);
